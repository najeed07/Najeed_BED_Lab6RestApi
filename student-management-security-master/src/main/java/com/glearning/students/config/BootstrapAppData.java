...
public class BootstrapAppData {
	...
	public void initializeUsersData(ApplicationReadyEvent readyEvent) {
			...
			User nabil = new User("nabil", passwordEncoder.encode("welcome"));
			User nk = new User("nk", passwordEncoder.encode("welcome"));
			
			Role userRole = new Role("ROLE_USER");
			Role adminRole = new Role("ROLE_ADMIN");
			
			nabil.addRole(userRole);
			
			nk.addRole(userRole);
			nk.addRole(adminRole);
			
			this.userRepository.save(nabil);
			this.userRepository.save(nk);
